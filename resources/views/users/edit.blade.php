...
<div class="container">
    <div class="row bg-white">
        ...
        @endif
        <div class="col-md-12">
            <form action="{{ route('userEdit.Store') }}" method="POST" class="row">
                @csrf
                <div class="col-md-6">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <a href="{{ route('redirectgoogle') }}" class="btn btn-danger mt-3"><i class="fa fa-google"
                            aria-hidden="true"></i>
                        Kết nối Google</a>
                    @endif
                    @if($user->facebook_id == null)
                    <a href="{{ route('redirectfacebook') }}" class="btn btn-primary mt-3"><i class="fa fa-facebook"
                            aria-hidden="true"></i> Kết nối Facebook</a>
                    @endif
                </div>
                <div class="col-md-12">
                    <hr>
                ...
                <div class="col-md-12 text-center mb-3">
                    <a href="{{route('userInfo')}}" class="btn btn-warning"><i class="fa fa-chevron-circle-left"
                            aria-hidden="true"></i> Quay lại</a>
                    <button type="submit" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i> Cập
