                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="fullname"
                                class="col-md-4 col-form-label text-md-right">{{ __('auth.fullName') }}</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 text-center">
                                <button type="submit" class="btn btn-success">
                                    <i class="fa fa-check" aria-hidden="true"></i> {{ __('auth.Register') }}
                                </button>
                            </div>
                            <div class="col-md-12 text-center">
                                <a href="{{ route('redirectgoogle') }}" class="btn btn-danger mt-3"><i
                                        class="fa fa-google" aria-hidden="true"></i>
                                    Đăng nhập Google</a>
                                <a href="{{ route('redirectfacebook') }}" class="btn btn-primary mt-3"><i
                                        class="fa fa-facebook" aria-hidden="true"></i> Đăng nhập Facebook</a>
                            </div>
                        </div>
                    </form>
                </div>
