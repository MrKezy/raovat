                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.vips.up',['id' => $post->id])}}"
                                        class="btn btn-primary button-info @if($post->users->role == 'block') disabled @endif"
                                        title="Duyệt VIP"><i class="fa fa-check" aria-hidden="true"></i></a>
                                    <a href="{{route('admin.vips.down',['id' => $post->id])}}"
                                        class="btn btn-danger button-info" title="Từ chối VIP"><i class="fa fa-times"
