        ...
        <div class="col-9 pt-3">
            <div class="row">
                <div class="col-12">
                    <div class="row">
                        <div class="col-8">
                            <h1>Quản lý bài viết hết hạn</h1>
                        </div>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <b class="text-danger">Đã hết hạn </b>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    @else
                                    <a href="{{route('admin.post.check',['id' => $post->id])}}"
                                        class="btn btn-danger button-info disabled" title="Nâng Vip"> <i
                                            class="fa fa-level-up" aria-hidden="true"></i></a>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
